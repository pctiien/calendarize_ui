            ...
            <div className="container text-center">
                ...
                <div className="row">
                    ...
                    <div className="col border border-1 d-flex gap-5 align-items-center py-2">
                        <div className="d-flex flex-column flex-fill border border-2 col-2 rounded-3 bg-danger" style={{height:'50px'}}>
                            <div className="d-flex flex-column align-items-start mx-3  ">
                                <p className=" m-0 h-auto w-auto" style={{fontSize:'15px'}}>Learning</p>
                                <p className=" fw-light m-0" style={{fontSize:'12px'}}>5:00 - 7:00</p>
                            </div>
                        </div>
